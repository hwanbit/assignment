...
import { supabase, downloadFile } from '../../lib/api.ts';
...
export const SubmissionsList: React.FC<SubmissionsListProps> = ({
      ...
      let query = supabase
        ...
        .select(`
          *,
          ...
          student:users!submissions_student_id_fkey(full_name, email),
  ...
  const handleDownloadFile = async (filePath: string, filename: string) => {
    try {
      const url = await downloadFile('submission-files', filePath);
      if (url) {
